...
print('Let it go')
model=keras.models.load_model('updated_hands.keras',custom_objects={"preprocess_input": preprocess_input})
...
#alnin a shekilin rengin ideyishirik ki mbizm model oyrensin
    ...
    cv2.rectangle(frame, (x, y), (w1, h1), (255, 0, 0), 2)
    cv2.putText(frame, number, (x, h1-10),
